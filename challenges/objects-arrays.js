...
*/
const zooPopulation = zooAnimals.map(population => population.population);
console.log(zooPopulation);
const lowPopulationAnimals = zooPopulation.filter(population => population < 5);
...
const zooPopulation = zooAnimals.map(population => population.population);
console.log(zooPopulation);
const populationTotal = zooPopulation.reduce((total, population) => total + population, 0); 
